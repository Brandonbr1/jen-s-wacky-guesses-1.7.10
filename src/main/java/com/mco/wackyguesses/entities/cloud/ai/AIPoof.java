...
public class AIPoof extends AnimationAI<EntityCloud>{
    ...
    public AIPoof(EntityCloud cloud, Animation animation) {
        super(cloud);
        setMutexBits(8);
        this.cloud = cloud;
    ...
    public void updateTask() {
        ...
        if (this.attackTarget != null && tick == 1 && this.cloud.getDistanceToEntity(this.attackTarget) < 3.0F) {
            ...
            this.attackTarget.knockBack(this.attackTarget, 0.5F, MathHelper.sin(this.cloud.rotationYaw * 0.017453292F),
                    -MathHelper.cos(this.cloud.rotationYaw * 0.017453292F));
        }
    }
