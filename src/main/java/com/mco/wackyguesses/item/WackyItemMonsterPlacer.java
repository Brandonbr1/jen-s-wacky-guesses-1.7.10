...
import com.mco.wackyguesses.item.WackyList.EntityEggInfo;
...
public class WackyItemMonsterPlacer extends ItemMonsterPlacer
{
    ...
    public String getItemStackDisplayName(ItemStack p_77653_1_) {
        ...
        String s1 = WackyList.getStringFromID(p_77653_1_.getItemDamage());
    ...
    public int getColorFromItemStack(ItemStack p_82790_1_, int p_82790_2_) {
        WackyList.EntityEggInfo entityegginfo = WackyList.entityEggs.get(Integer.valueOf(p_82790_1_.getItemDamage()));
    ...
    public static Entity spawnCreature(World p_77840_0_, int p_77840_1_, double p_77840_2_, double p_77840_4_, double p_77840_6_) {
        if (!WackyList.entityEggs.containsKey(Integer.valueOf(p_77840_1_)))
            return null;
        else {
            Entity entity = null;

            for (int j = 0; j < 1; ++j) {
                entity = WackyList.createEntityByID(p_77840_1_, p_77840_0_);
    ...
    public void getSubItems(Item p_150895_1_, CreativeTabs p_150895_2_, List p_150895_3_) {
        for (EntityEggInfo entityegginfo : WackyList.entityEggs.values()) {
