...
//    }
    ...
    mod {
        modid   = "wackyguesses"   //REQUIRED
        name    = "Jen's Wacky Guesses"  //REQUIRED
//        version = "autogenerated from git" //Convention
        rootPkg = "$group.wackyguesses" //REQUIRED
    }

    // optional
    // for runClient/runServer
    run {
        username = "WackyGuessesDevAccount" //Convention, client only
        userUUID = "00000000-0000-4500-0006-000000000000" //optional, client only
    }
...
dependencies {
   devOnlyNonPublishable(deobfCurse("llibrary-243298:5718845"))
    /*
